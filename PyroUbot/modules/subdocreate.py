...
__HELP__ = """
<b>⦪ ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ Subdomain Creator ⦫</b>

<blockquote><b>⎆ ᴘᴇʀɪɴᴛᴀʜ :
ᚗ <code>{0}subdocreate</code> [domain] [subdomain] [IP]
ᚗ Menambahkan subdomain ke domain yang tersedia di Cloudflare.

ᚗ <code>{0}listdomain</code>
ᚗ Untuk melihat list domain.

⎆ Contoh:
ᚗ <code>{0}subdocreate</code> example.com test 192.168.1.1

ᚗ <code>{0}domainlist</code> untuk melihat daftar domain yang tersedia.</blockquote>
"""
